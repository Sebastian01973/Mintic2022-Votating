...
@app.route("/zrk5nkf/politicalParty/<string:id>", methods=['PUT'])
...
@app.route("/zrk5nkf/politicalParty/<string:id>", methods=['DELETE'])
...
@app.route("/zrk5nkf/candidates/<string:id_candidate>", methods=['PUT'])
...
@app.route("/zrk5nkf/candidates/<string:id_candidate>", methods=['DELETE'])
...
@app.route("/zrk5nkf/candidates/<string:id_candidate>/politicalParty/<string:id_politicalParty>", methods=['PUT'])
...
@app.route("/zrk5nkf/boards",methods=['GET'])
def get_boards():
    json = myControllerBoard.index()
    return jsonify(json)

#Metodo para crear una mesa 
@app.route("/zrk5nkf/boards",methods=['POST'])
def create_board():
    data = request.get_json()
...
@app.route("/zrk5nkf/boards/<string:id>",methods=['GET'])
def get_board(id):
    json = myControllerBoard.show(id)
    return jsonify(json)

#Metodo para actualizar una mesa por el ID
@app.route("/zrk5nkf/boards/<string:id>",methods=['PUT'])
def update_board(id):
    data = request.get_json()
...
@app.route("/zrk5nkf/boards/<string:id>",methods=['DELETE'])
def delete_board(id):
...
@app.route("/zrk5nkf/results", methods=['GET'])
def get_results():
    json = myControllerResult.index()
    return jsonify(json)

#OBTENER UN RESULTADO EN ESPECIFICO
@app.route("/zrk5nkf/results/<string:id>", methods=['GET'])
def get_result(id):
    json = myControllerResult.show(id)
    return jsonify(json)

#agregar un resultado en una mesa
@app.route("/zrk5nkf/results/board/<string:id_board>/candidate/<string:id_candidate>", methods=['POST'])
...
@app.route("/zrk5nkf/results/<string:id_result>/board/<string:id_board>/candidate/<string:id_candidate>",methods=['PUT'])
...
@app.route("/zrk5nkf/results/<string:id>", methods=['DELETE'])
...
@app.route("/zrk5nkf/reports/boards/<string:id_board>",methods=['GET'])
...
@app.route("/zrk5nkf/reports/candidate/<string:id_candidate>",methods=['GET'])
...
@app.route("/zrk5nkf/reports/newIdentification",methods=['GET'])
def get_new_identification():
    json = myControllerResult.get_new_identification()
    return jsonify(json)

 #Metodo para encontrar la mesa y el partido
@app.route("/zrk5nkf/reports/board/<string:id_board>/political/<string:id_party>",methods=['GET'])
